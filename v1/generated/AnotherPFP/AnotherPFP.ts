...
export class AnotherPFP extends ethereum.SmartContract {
  static bind(address: Address): AnotherPFP {
    return new AnotherPFP("AnotherPFP", address);
  }

  addressMintedPerSeason(param0: BigInt, param1: Address): boolean {
    let result = super.call(
      "addressMintedPerSeason",
      "addressMintedPerSeason(uint256,address):(bool)",
      [
  ...
  merkleRootPerSeason(param0: BigInt): Bytes {
    let result = super.call(
      "merkleRootPerSeason",
      "merkleRootPerSeason(uint256):(bytes32)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
  ...
  try_merkleRootPerSeason(param0: BigInt): ethereum.CallResult<Bytes> {
    let result = super.tryCall(
      "merkleRootPerSeason",
      "merkleRootPerSeason(uint256):(bytes32)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
...
export class SetSeasonCall extends ethereum.Call {
  get inputs(): SetSeasonCall__Inputs {
    return new SetSeasonCall__Inputs(this);
  }

  get outputs(): SetSeasonCall__Outputs {
    return new SetSeasonCall__Outputs(this);
  }
}

export class SetSeasonCall__Inputs {
  _call: SetSeasonCall;

  constructor(call: SetSeasonCall) {
    this._call = call;
  }
...
export class SetSeasonCall__Outputs {
  _call: SetSeasonCall;
